...
class TestAmenity_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        b = a.__str__()
        self.assertIn("[Amenity] (123456)", b)
        self.assertIn("'id': '123456'", b)
        self.assertIn("'created_at': " + dt_repr, b)
        self.assertIn("'updated_at': " + dt_repr, b)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        dt = datetime.today()
        dt_iso = dt.isoformat()
        am = Amenity(id="123", created_at=dt_iso, updated_at=dt_iso)
...
class TestAmenity_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        ...
        am.middle_name = "Musa"
        am.my_number = 98
        self.assertEqual("Musa", am.middle_name)
